...
- **Lakehouse operator expansion (§6.2.2):** Storage (MinIO/S3 object ops), Ingestion (SFTP/FTP/IMAP), Compute (Spark, Papermill), Data Quality (SQL checks), and Notification **operators** (Email/Slack/…) — gated registry YAML. **P0 + P1 shipped ✅** (15 ops, catalogue → 33); **P2 📝**; third‑party Great Expectations / OpenMetadata at **P3 🔭**.
